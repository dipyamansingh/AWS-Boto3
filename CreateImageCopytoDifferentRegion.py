...
instances = ec2.instances.filter(InstanceIds=['i-0067eeaab6c8198fd'])

image_ids = []

for instance in instances:
    image = instance.create_image(Name='Demo Deep - '+instance.id, Description='Demo Boto'+instance.id)
